    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-sun'></i> Подтвердите вашу почту
            </h1>
        </div>
        <?= flash()->display('error')?>
        <form action="/email_check"  method="post">
            <div class="row">
                <div class="col-xl-6">
                    <div class="col-md-4">
                        <h1>Ваш Токен</h1>
                        <input type="text" name="token" value="Ваш токен">
                        <h1>Ваш Селектор</h1>
                        <input type="text" name="selector" value="Ваш Селектор">
                        <button class="btn btn-warning" >Подтвердтить почту</button>
                    </div>
                </div>
            </div>
        </form>
