...
$trimmedUserGET =trim($_GET['route'],'security/id=');
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <?= flash()->display('error');?>
        <form action="/security/id=<?php echo $user[0]['id'];?>/security" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="oldPassword" id="simpleinput" class="form-control" required placeholder="Ваш старый пароль">
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Пароль</label>
                                    <input type="password" name="newPassword" id="simpleinput" class="form-control" required placeholder="Ваш новый пароль">
                                </div>

                                <!-- password confirmation-->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Подтверждение пароля</label>
                                    <input type="password" name="repeat_newPassword" id="simpleinput" class="form-control" required placeholder="Повторите пароль">
