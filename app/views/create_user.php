...
if(!$auth->getRoles(\Delight\Auth\Role::ADMIN)){
    flash()->error('Туда можно только админу');
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/create_user/create" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="work_place" id="simpleinput" class="form-control" required placeholder="Ваше место работы">
                                </div>
