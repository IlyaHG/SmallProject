...
$this->layout('layout', ['title' => 'Пользователи']);
...
if(!$auth->isLoggedIn()){
    flash()->error('Сначала нужно залогиниться');
...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <?php if($auth->getRoles(\Delight\Auth\Role::ADMIN)): ?>
            <div class="row">
                <div class="col-xl-12">
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=$user['datafiltertag'],"Андрей"?>",<?="Андрей";?>>
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?= $user['status'];?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('/uploads/<?= $user['avatar']?>'); background-size: cover;"></span>
                                </span>
...
<!--                                        --><?php
                                        ...
                                        if($auth->getRoles(\Delight\Auth\Role::ADMIN) || ($current_user == $user['id'])): ?>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="page_profile/id=<?=$user['id'];?>">
                                        ...
                                        <a class="dropdown-item" href="set_status/id=<?= $user['id'];?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
